...
# verfified_user = set(list(verified_user)[:10])
...
for entry in tqdm.tqdm(all_videos):
    ...
    print(print(dic['duetFromId'], type(dic['duetFromId']), dic['duetFromId'] is not None and dic['duetFromId'] != 0))
    if dic['duetFromId'] is not None and dic['duetFromId'] != '0':
        countDuet+= 1
